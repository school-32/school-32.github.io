<div class='menu-con-message fade-out-onload'>
	<div class='menu-tx1-message toggle-message fade-out-onload'>
		<span>В настоящее время мы наблюдаем более высокий объем серверов, чем обычно. Приносим искренние извинения за доставленные неудобства.</span>
	</div>
</div>
<div class="window-con-theme">
	...
	<div class="theme-tx1-description pulsate">
		<span>Эта функция в настоящее время еще недоступна</span>
	</div>
...
<div class='menu-con-container'>
	...
	<div class="menu-con-outer">
		<div class="menu-con-inner">
			...
			<a href='https://docs.google.com/document/d/1RuOjcWknhQm1fCs16AuYsy3VY_k3gXXe/edit?usp=sharing&ouid=116097260214711252104&rtpof=true&sd=true' target="_blank">
			<div class="menu-btn-select">
				<span>Положение</span>
			</div>
			</a>
